...
usac_units <- readxl::read_excel(
  "output/locations_ref.xlsx", sheet = "units"
) %>%
...
if(knitr::is_html_output()){
  ...
  cases %>%
    ...
    leaflet::addPolygons(
      data = usac_zones, color = "black", fillOpacity = 0,
...
harassment_counts <- dashboard_usac %>%
  ...
  mutate(
    harassment_type_rec = case_when(
      ...
      grepl("El acosador acudió a terceras", harassment_type_rec) ~ "acoso por medio de terceros",
...
<span width="100%" style="position: absolute; bottom: 0; display:table; margin:0 auto;">
<img src="img/logo-aeu-negro.png" height="200px"></img>
<img src="img/logo-fcam.png" height="200px"></img>
</span>
